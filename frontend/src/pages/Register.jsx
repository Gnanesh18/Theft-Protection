  ...
  const portals = [
    {
      ...
      description: 'Report local theft incidents, receive notifications, and track case progress.',
      icon: Shield,
    ...
    {
      id: 'officer',
      title: 'Police Officer Registration',
      description: 'Request authorized credential registration to log case files and manage precinct dossiers.',
      icon: ShieldCheck,
    ...
    <div className="flex-grow flex flex-col justify-center items-center py-16 px-4 sm:px-6 lg:px-8 relative grid-bg min-h-[calc(100vh-4rem)]">
      ...
      <div className="max-w-4xl w-full text-center space-y-4 mb-12 relative z-10">
        ...
        >
          ...
          <span>Profile Enrollment Center</span>
        </motion.div>
        ...
        >
          Select your registration portal type below to register your credentials.
        </motion.p>
      </div>
      ...
      <p className="text-center text-xs text-slate-light mt-8 relative z-10">
        Already registered?{' '}
        <Link to="/login" className="text-white hover:underline font-semibold font-sans">
          Secure Login
        </Link>
      </p>
    </div>
